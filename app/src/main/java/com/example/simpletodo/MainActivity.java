       ...
       btnAdd.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
              ...
              //Add item to the model
               items.add(todoItem);
               //Notify adapter (calling adapter that we defined) that an item is inserted
               //position the item is inserted is going to be the last position
        ...
        //handle the result fo the edit activity
    @Override
